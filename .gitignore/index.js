...
bot.on('message', message => {
    ...
    if (message.content.startsWith(prefix + "sondage")) {
        message.delete()
        if (!message.member.roles.has(message.guild.roles.find("name", "STAFF").id)) return message.reply("Vous n'avez pas la permission");
            ...
            var embed = new Discord.RichEmbed()
                ...
                .setColor("FF0000T")
                .setTimestamp()
            message.guild.channels.find("name","dev").sendEmbed(embed)
